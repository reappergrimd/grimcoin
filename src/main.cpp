...
uint256 hashGenesisBlock("0x259922278aab02d831e6de5b6fb308fe32bd4c29552ae5f1371aa6273463f2b2");
...
const string strMessageMagic = "Grimcoin Signed Message:\n";
...
{
    // Grimcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    int64 nSubsidy = 600000000000;

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 84000000); // Grimcoin: 840k blocks in ~4 years
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Grimcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Grimcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Grimcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xc1c6973630382be40293795a574a94f8e4c77785d0a41d2db0991244350098ce");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].nValue = 600000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0ccf52c3b3c945f96c77e60d37f1b359b5f15dbe9de68e0bc9847a5198da17b33acabbeaf6332317bbf7973cd9fc35441fc5b1c238e26461ac7270cf9f41da1745") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1448572198;
        block.nBits    = 520343692;
        block.nNonce   = 1393397843;

        if (fTestNet)
        {
            block.nTime    = 1448572198;
            block.nNonce   = 1851440261;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x2b4c6c092bd784cf20a9ab0cc605bb01798cf62084f6a78a7a1e7ca6e96efa36"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Grimcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("GrimcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("GrimcoinMiner : ProcessBlock, block not accepted");
    }
